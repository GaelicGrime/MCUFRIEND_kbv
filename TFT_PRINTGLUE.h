...
class TFT_PRINTGLUE : public MCUFRIEND_kbv_mods
{
    public:
        TFT_PRINTGLUE() {}
        void begin(void) {
        ...
        void setCursor(int16_t x, int16_t y, uint8_t idx = 255)
        {
            ...
            setTextFont(idx);
            MCUFRIEND_kbv_mods::setCursor(x, y + _ydatum);
        }
        ...
        void setFreeFont(const GFXfont *pfont)
        {
            ...
            _ascent = 7;
            _descent = 1;
            MCUFRIEND_kbv_mods::setFont(_pfont = pfont);
            if (pfont != NULL) {
        ...
        int16_t drawString(const char *string, int16_t poX, int16_t poY, uint8_t idx)
        {
            ...
            MCUFRIEND_kbv_mods::setCursor(poX, poY + _ydatum);
            print(string);
            return w;
        }
