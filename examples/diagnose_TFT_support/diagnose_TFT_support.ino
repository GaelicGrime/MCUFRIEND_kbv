...
uint16_t version = MCUFRIEND_KBV_MODS_H_;
...
void setup()
{
    ...
    Serial.println(F(""));
	Serial.print(F("MCUFRIEND_kbv_mods version: "));
    ...
    if (tft.width() == 0) {
        ...
        Serial.println(F("you may need to edit MCUFRIEND_kbv_mods.cpp"));
...
void loop()
{
    ...
    tft.setTextSize(1);
    tft.print("MCUFRIEND_KBV_MODS_H_ = ");
    tft.print(version);
